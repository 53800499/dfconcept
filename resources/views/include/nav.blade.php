<nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
    <div class="container">
      <a class="navbar-brand" href="index.html">DF Concepts</a>
      ...
      <div class="collapse navbar-collapse" id="ftco-nav">
        <ul class="navbar-nav ml-auto">
          ...
          @if (Session::has('client'))
            <li class="nav-item cta cta-colored"><a href="{{URL::to('/logout')}}" class="nav-link"><span class="icon-shopping_cart"></span>Logout</a></li>
          @else
            <li class="nav-item cta cta-colored"><a href="{{URL::to('/loginup')}}" class="nav-link"><span class="fa fa-user"></span>Sign</a></li> 
          @endif
        </ul>
      </div>
    </div>
