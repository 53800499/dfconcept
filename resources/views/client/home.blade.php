	        ...
	        <div class="container">
	          <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">
	            ...
	            <div class="col-md-12 ftco-animate text-center">
	              <h1 class="mb-2">Bienvenu sur notre site</h1>
	              <h2 class="subheading mb-4">Nous somme joignable a tout moment</h2>
	        ...
	        <div class="container">
	          <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">
	            ...
	            <div class="col-sm-12 ftco-animate text-center">
	              <h1 class="mb-2">Decouvre les meilleurs conceptions</h1>
	              <h2 class="subheading mb-4">Nous somme joignable a tout moment</h2>
	              <p><a href="#" class="btn btn-primary">Voir Details</a></p>
	            </div>
